...
const menuItems = [
    ...
    // -------- DESSERTS --------
    { key: 'qubani-ka-meetha', title: 'Qubani Ka Meetha 250 Gms', price: '₹107', dietType: 'veg', foodCategory: 'desserts', description: 'Classic Hyderabadi dessert made with dried apricots simmered in sugar syrup, topped with fresh cream. A royal finish to any meal.' },
    ...
    { key: 'thums-up', title: 'Thums Up', price: 'MRP', dietType: 'veg', foodCategory: 'beverages', description: 'Bold and fizzy cola with a strong, distinctive taste. India\'s thunder!' },
    { key: 'mineral-water', title: 'Mineral Water', price: 'MRP', dietType: 'veg', foodCategory: 'beverages', description: 'Pure, refreshing mineral water to cleanse the palate.' },
    { key: 'maaza', title: 'Maaza', price: 'MRP', dietType: 'veg', foodCategory: 'beverages', description: 'Mango-flavored fruit drink, sweet and refreshing. A tropical treat.' },
    { key: 'sprite', title: 'Sprite', price: 'MRP', dietType: 'veg', foodCategory: 'beverages', description: 'Clear, crisp lemon-lime soda. Refreshingly cool and bubbly.' },
    { key: 'coke-tin', title: 'Coke Tin', price: 'MRP', dietType: 'veg', foodCategory: 'beverages', description: 'Classic Coca-Cola in a convenient tin. Ice-cold fizzy refreshment.' },
    { key: 'coke', title: 'Coke', price: 'MRP', dietType: 'veg', foodCategory: 'beverages', description: 'The classic Coca-Cola — perfectly carbonated and endlessly refreshing.' },
    { key: 'fanta', title: 'Fanta', price: 'MRP', dietType: 'veg', foodCategory: 'beverages', description: 'Bright, bubbly orange-flavored soda. Fun and fruity refreshment.' }
];
...
function navigateCarousel(type, direction) {
    ...
    if (type === 'videos') {
        ...
        if (newVideo) newVideo.play().catch(e => console.log('Auto-play prevented:', e));
    }
}
